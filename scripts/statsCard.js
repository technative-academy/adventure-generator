function statsTabs() {
    document.querySelectorAll('.stats__card__tabs__button').forEach((button) => {
        button.addEventListener('click', () => {
            const sideBar = document.querySelector('.stats__card__tabs')
            const tabsContainer = document.querySelector('.stats__card__quote__container')
            ...
            sideBar
                ...
                .forEach((btn) => {
                    btn.classList.remove('stats__card__tabs__button--active')
                })
